...
-- 4. Remover e recriar RLS Policies para user_roles
...
-- 5. Remover e recriar RLS policies para tabela clientes
...
-- 6. Remover e recriar RLS policies para tabela equipe
...
DROP POLICY IF EXISTS "Admins can view equipe" ON public.equipe;
DROP POLICY IF EXISTS "Admins can insert equipe" ON public.equipe;
DROP POLICY IF EXISTS "Admins can update equipe" ON public.equipe;
DROP POLICY IF EXISTS "Admins can delete equipe" ON public.equipe;
...
-- 7. Remover e recriar RLS policies para tabela eventos
...
DROP POLICY IF EXISTS "Admins can view eventos" ON public.eventos;
DROP POLICY IF EXISTS "Admins can insert eventos" ON public.eventos;
DROP POLICY IF EXISTS "Admins can update eventos" ON public.eventos;
DROP POLICY IF EXISTS "Admins can delete eventos" ON public.eventos;
...
-- 8. Remover e recriar RLS policies para tabela financeiro
...
DROP POLICY IF EXISTS "Admins can view financeiro" ON public.financeiro;
DROP POLICY IF EXISTS "Admins can insert financeiro" ON public.financeiro;
DROP POLICY IF EXISTS "Admins can update financeiro" ON public.financeiro;
DROP POLICY IF EXISTS "Admins can delete financeiro" ON public.financeiro;
...
-- 9. Remover e recriar RLS policies para tabela lista_espera
...
DROP POLICY IF EXISTS "Admins can view lista_espera" ON public.lista_espera;
DROP POLICY IF EXISTS "Admins can insert lista_espera" ON public.lista_espera;
DROP POLICY IF EXISTS "Admins can update lista_espera" ON public.lista_espera;
DROP POLICY IF EXISTS "Admins can delete lista_espera" ON public.lista_espera;
...
-- 10. Remover e recriar RLS policies para tabela servicos
...
DROP POLICY IF EXISTS "Admins can view servicos" ON public.servicos;
DROP POLICY IF EXISTS "Admins can insert servicos" ON public.servicos;
DROP POLICY IF EXISTS "Admins can update servicos" ON public.servicos;
DROP POLICY IF EXISTS "Admins can delete servicos" ON public.servicos;
...
-- 11. Remover e recriar RLS policies para tabela alocacao_equipe
...
DROP POLICY IF EXISTS "Admins can view alocacao_equipe" ON public.alocacao_equipe;
DROP POLICY IF EXISTS "Admins can insert alocacao_equipe" ON public.alocacao_equipe;
DROP POLICY IF EXISTS "Admins can update alocacao_equipe" ON public.alocacao_equipe;
DROP POLICY IF EXISTS "Admins can delete alocacao_equipe" ON public.alocacao_equipe;
